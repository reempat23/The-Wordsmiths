...
goToAnotherPage.addEventListener("click", () => {
    window.location.href = "https://script.google.com/a/macros/tn.ac.th/s/AKfycbzpDg7x_K8AJKu3F1serqwaDAl1zpLRoCW7dtMyIvBOftDW-I_Ov0_CdgbgLe8HIt4wmw/exec"; // เปลี่ยนลิงก์เป็นเว็บที่ต้องการ
});
